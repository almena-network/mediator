...
<style>
:root{{color-scheme:dark;--brand:#2f6fed;--bg:#0f1013;--glow:rgba(47,111,237,.22);--surface:rgba(255,255,255,.06);--border:rgba(255,255,255,.1);--hover:rgba(255,255,255,.07);--text:#f4f4f6;--muted:rgba(244,244,246,.6);--ok:#3ddc84;--down:#ff6b5e}}
